...
public class PageNavigationView extends ViewGroup
{
    ...
    private class Controller implements BottomLayoutController{
        ...
        @Override
        public void setupWithViewPager(ViewGroup viewPager) {
            if(viewPager == null){return;}

            mViewPager = (LazyViewPager) viewPager;
...
//                mViewPager.addOnPageChangeListener(mPageChangeListener);
    ...
    private class ViewPagerPageChangeListener implements LazyViewPager.OnPageChangeListener{
