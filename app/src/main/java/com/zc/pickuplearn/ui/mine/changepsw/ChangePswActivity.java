...
public class ChangePswActivity extends BaseActivity {
    ...
    public void initView() {
        mHeadView.setTitle(UIUtils.getString(R.string.setting_changepsw));
    ...
    @OnClick({R.id.dialog_change_pwd_ok})
    ...
    private void ChangePswAction() {
        ...
        if (pswOld.equals("")) {
            Toast.makeText(ChangePswActivity.this, "旧密码不能为空！",
                    Toast.LENGTH_SHORT).show();
        } else {
            if (pswNew1.equals("") || pswNew1.length() < 6) {
                Toast.makeText(ChangePswActivity.this, "新密码不能少于六位",
                        Toast.LENGTH_SHORT).show();
            } else if (pswNew1.equals(pswNew2)) {
                loading.showProgressDialog();
                changePsw(pswOld, pswNew1, pswNew2);
            } else {
                Toast.makeText(ChangePswActivity.this, "两次密码不一致！",
                        Toast.LENGTH_SHORT).show();
            }
        }
    }

    private void changePsw(final String oldPsw, final String newPsw1,
                           final String newPsw2) {
        ...
        try {
                ...
                public void onResponse(String response, int id) {
                    ...
                    try {
                        ...
                        if (flag) {
                            ...
                            Toast.makeText(ChangePswActivity.this, "密码修改成功！",
                                    Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            ...
                            Toast.makeText(ChangePswActivity.this, reason,
                                    Toast.LENGTH_SHORT).show();
                        }
            ...
            ToastUtils.showToast(ChangePswActivity.this, "操作失败！请稍后再试");
        } finally {
