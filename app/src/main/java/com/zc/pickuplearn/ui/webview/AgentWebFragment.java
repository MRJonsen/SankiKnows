...
public class AgentWebFragment extends Fragment implements FragmentKeyDown {
    ...
    OnUrlLoadFinishListener mUrlChangeListener;
    ...
    private void urlChange() {
        ...
        //网页需要结束页面监听
        setOnUrlLoadFinishListener(new OnUrlLoadFinishListener() {
            @Override
     ...
     * @param listener
     */
    public void setOnUrlLoadFinishListener(OnUrlLoadFinishListener listener){
        mUrlChangeListener = listener;
    }

    private void initJsInterface(AgentWeb agentWeb) {
        if (agentWeb != null)
            agentWeb.getJsInterfaceHolder().addJavaObject("android", new AndroidInterface(agentWeb, this.getActivity()) {
  ...
  public void setBarInit() {
        if (this.getArguments().getBoolean(BAR_KEY,false)) {
            if (null!=toolbar){
    ...
    protected WebViewClient mWebViewClient = new WebViewClient() {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            LogUtils.e("页面加载完成",url);
            if (mUrlChangeListener!=null){
                mUrlChangeListener.onUrlfinish(url);
            }
        }
    };
