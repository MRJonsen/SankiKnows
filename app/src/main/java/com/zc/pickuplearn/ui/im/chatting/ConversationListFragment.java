...
public class ConversationListFragment extends BaseFragment {
    ...
    private static String TYEP_TAG = "type_tag";
...
//    private MenuItemController mMenuController;
    ...
    private ListType listTye;


    public static ConversationListFragment newInstance(ListType listTye) {
        ConversationListFragment fragment = new ConversationListFragment();
        Bundle bundle = new Bundle();
        bundle.putSerializable(TYEP_TAG, listTye);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRootView = UIUtils.inflate(R.layout.fragment_conv_list);
        mConvListView = new ConversationListView(mRootView, this.getActivity());
        mConvListView.initModule();
        listTye = (ListType) getArguments().getSerializable(TYEP_TAG);
        if (mRootView != null) {
            mRootView.findViewById(R.id.rl_title).setVisibility(View.GONE);
        }
...
//        mMenuView = getActivity().getLayoutInflater().inflate(R.layout.drop_down_menu, null);
        mConvListController = new ConversationListController(mConvListView, this, mWidth,listTye);
