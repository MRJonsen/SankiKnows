...
public class MyFunctionAdapter extends BaseAdapter implements DragAdapterInterface {
    private boolean IsEdit = false;
    private List<FunctionBean> datas = new ArrayList<FunctionBean>();
    private FunctionEditActivity context;

    public MyFunctionAdapter(FunctionEditActivity context, List<FunctionBean> datas) {
...
//        });
    ...
    public List<FunctionBean> getDatas() {
        int i = 1;
        for (FunctionBean functionBean : datas) {
            functionBean.setSORT(i + "");
            i++;
        }
        return datas;
    }
