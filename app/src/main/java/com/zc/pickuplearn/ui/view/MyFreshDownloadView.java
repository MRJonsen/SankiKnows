...
public class MyFreshDownloadView extends View {


    private final String TAG = MyFreshDownloadView.class.getSimpleName();
    ...
    private final String STR_PERCENT = "分";
    ...
    public MyFreshDownloadView(Context context) {
        this(context, null);
    }

    public MyFreshDownloadView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public MyFreshDownloadView(Context context, AttributeSet attrs, int defStyleAttr) {
