package com.zc.pickuplearn.ui.sign.widget;
...
public class SignCalendar extends LinearLayout {
    ...
    private void setArrowEnable(ImageView arrowImage, Direction direction) {
        if (direction == Direction.LEFT) {
            ...
            Bitmap leftArrowBtp = BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.cal_left_arrow);
            ...
            arrowImage.setClickable(true);
            Bitmap rightArrowBtp = BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.cal_right_arrow);
