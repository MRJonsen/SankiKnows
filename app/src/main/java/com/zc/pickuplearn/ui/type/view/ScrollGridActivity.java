...
import com.zc.pickuplearn.ui.type.widget.ProTypeFragment;
...
public class ScrollGridActivity extends FragmentActivity {
    ...
    public static void startScrollGridActivity(Context context, TypeGreenDaoEvent event) {
        Intent intent = new Intent(context, ScrollGridActivity.class);
...
//        });
    ...
    private void initView() {
        mHeadView = (HeadView) findViewById(R.id.hv_headbar);
        mHeadView.setTitle("分 类");
        getParam();
        ...
        public void onClick(View v) {
            if (System.currentTimeMillis() - mClickTime.get(v.getId()) < 200) {
                ...
                if (function == TypeGreenDaoEvent.Type) {
                    ...
                    DynamicMoreActivity.startDynamicMoreActivity(ScrollGridActivity.this, "", questionBean, "");//根据分类去找找问题
    ...
    private class ShopAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int index) {
            ...
            ProTypeFragment proTypeFragment = ProTypeFragment.newInstance((ArrayList<QusetionTypeBean>) qusetionTypeBeen, function);
