...
/**
 *
 * Created by chenbin on 2017/11/20.
 */
...
public class GlideImageLoader extends ImageLoader {
    ...
    public void displayImage(Context context, Object path, ImageView imageView) {
        /**
         ...
         切记不要胡乱强转！
         */
        ImageLoaderUtil.showImageView(context, ResultStringCommonUtils.subUrlToWholeUrl(((ClassicCaseBean)path).getFILEURL()), imageView);
    }
}