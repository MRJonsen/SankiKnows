...
import com.zc.pickuplearn.ui.im.chatting.MsgListAdapter.ViewHolder;
import com.zc.pickuplearn.ui.im.chatting.activity.BrowserViewPagerActivity;
import com.zc.pickuplearn.ui.im.chatting.entity.FileType;
import com.zc.pickuplearn.ui.im.chatting.utils.FileHelper;
import com.zc.pickuplearn.ui.im.chatting.utils.HandleResponseCode;
import com.zc.pickuplearn.ui.im.chatting.utils.IdHelper;
...
public class ChatItemController {
    ...
    public void handleTextMsg(final Message msg, final MsgListAdapter.ViewHolder holder, int position) {
        ...
        if (msg.getDirect() == MessageDirect.send) {
            ...
            if (mConv.getType() == ConversationType.group) {
                ...
                if (msg.getFromUser()!=null&&TextUtils.isEmpty(msg.getFromUser().getNickname())) {
    ...
    // 处理图片
    public void handleImgMsg(final Message msg, final MsgListAdapter.ViewHolder holder, final int position) {
    ...
    private void sendingImage(final Message msg, final MsgListAdapter.ViewHolder holder) {
        holder.picture.setAlpha(0.75f);
        holder.sendingIv.setVisibility(View.VISIBLE);
        holder.sendingIv.startAnimation(mSendingAnim);
        holder.progressTv.setVisibility(View.VISIBLE);
