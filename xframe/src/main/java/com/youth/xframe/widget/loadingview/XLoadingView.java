...
public class XLoadingView extends FrameLayout {
    ...
    public final void showEmpty(String warnning){
        show(mEmptyViewResId);
    }
    ...
    public void setEmptyViewWarning(String warning){
        ((TextView)layout(mEmptyViewResId).findViewById(R.id.tv_empty_text)).setText(warning);
    }
    public void setEmptyView(int resourceId){
        ((ImageView)layout(mEmptyViewResId).findViewById(R.id.iv_image)).setImageResource(resourceId);
    }
}
