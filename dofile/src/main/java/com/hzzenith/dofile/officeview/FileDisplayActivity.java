package com.hzzenith.dofile.officeview;
...
import com.hzzenith.dofile.utils.Md5Tool;
...
public class FileDisplayActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        init();
        Toolbar mCommonToolbar = (Toolbar) findViewById(R.id.common_toolbar);
        mCommonToolbar.setNavigationIcon(R.mipmap.back);
